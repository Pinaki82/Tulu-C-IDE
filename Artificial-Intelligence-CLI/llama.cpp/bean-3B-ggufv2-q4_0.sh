...
# https://huggingface.co/Aryanne/Bean-3B-ggml-and-gguf
# https://huggingface.co/Aryanne/Bean-3B-ggml-and-gguf/tree/main
...
./main  -m models/bean-3B-ggufv2-q4_0.gguf --color \
